        ...
        <div className="space-y-14 text-white/55 leading-relaxed text-[15px]">
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>
                TrailIQ הוא מהאתרים הראשונים בעולם שמשלב בינה מלאכותית (AI) בתחום ציוד הטיולים.
                בניגוד לאתרים רגילים שבהם אתה מחפש מוצרים ידנית ומנסה להבין לבד מה מתאים לך —
                אצלנו אתה פשוט מספר על הטיול שלך ומקבל המלצות מותאמות אישית תוך שניות.
              </p>
              <p>
                המערכת שלנו מנתחת את היעד, מזג האוויר בזמן אמת, משך הטיול, התקציב וההעדפות שלך —
                ומציעה בדיוק את הציוד שאתה צריך. לא עוד שעות של חיפוש בעשרות אתרים ופורומים.
                לא עוד ניחושים.
              </p>
              <p>
                בנוסף, האתר מציג לכל מוצר שלוש רמות מחיר —{" "}
                <span className="text-white/75 font-medium">חסכוני</span>,{" "}
                <span className="text-white/75 font-medium">מומלץ</span>{" "}
                ו<span className="text-white/75 font-medium">פרימיום</span> — כך שכל מטייל מוצא את
                מה שמתאים לתקציב שלו. אנחנו מציגים מזג אוויר אמיתי בזמן אמת באמצעות שירותי מזג
                אוויר בינלאומיים, ואת המחירים במטבע המקומי של כל משתמש — כדי שההמלצות יהיו
                מדויקות ונוחות ככל האפשר.
              </p>
              <p className="text-white/70 font-medium">
                זו לא רק חנות ציוד — זה היועץ האישי שלך לכל הרפתקה.
              </p>
            </div>
          </section>
